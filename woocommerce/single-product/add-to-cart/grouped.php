...
<form class="cart grouped_form"
                ...
                switch ($column_id) {
                    case 'quantity':
                        ...
                        if (!$grouped_product_child->is_purchasable() || $grouped_product_child->has_options() || !$grouped_product_child->is_in_stock()) {
                            ...
                            echo '<input type="checkbox" name="' . esc_attr('quantity[' . $grouped_product_child->get_id() . ']') . '" value="1" class="wc-grouped-product-add-to-cart-checkbox fs-checkbox" />';
                        } else {
    ...
    <?php if ($quantites_required && $show_add_to_cart_button) : ?>
        ...
        <button type="submit"
                class="single_add_to_cart_button fs-button dark-style"><?php echo esc_html($product->single_add_to_cart_text()); ?></button>
